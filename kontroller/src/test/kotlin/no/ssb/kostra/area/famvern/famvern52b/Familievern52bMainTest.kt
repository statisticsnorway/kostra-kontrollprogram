            ...
            inputFileContent = " ".repeat(Familievern52bFieldDefinitions.fieldDefinitions.last().to)
                ...
                .plus(
                    mapOf(
                        ...
                        Familievern52bColumnNames.STRUKTUR_GR_B_COL_NAME to Familievern52bFieldDefinitions.fieldDefinitions.byColumnName(
                            Familievern52bColumnNames.STRUKTUR_GR_B_COL_NAME
                        ).codeList.first().code,
                        Familievern52bColumnNames.HOVEDI_GR_B_COL_NAME to Familievern52bFieldDefinitions.fieldDefinitions.byColumnName(
                        ...
                        Familievern52bColumnNames.TOLK_B_COL_NAME to Familievern52bFieldDefinitions.fieldDefinitions.byColumnName(
                            Familievern52bColumnNames.TOLK_B_COL_NAME
                        ).codeList.first().code,
                        Familievern52bColumnNames.STATUS_ARETSSL_B_COL_NAME to Familievern52bFieldDefinitions.fieldDefinitions.byColumnName(
