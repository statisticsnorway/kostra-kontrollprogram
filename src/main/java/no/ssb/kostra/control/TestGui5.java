...
//          error_type_found =
        	new ControlProgram().doControl (new String[] {jTextField1.getText(),
              getInfile(), getOutfile(),Integer.toString(ControlProgram.REGNSKAP),(String)jComboBox3.getSelectedItem()+"K"+((String)jComboBox4.getSelectedItem()).substring(0,1),jTextField2.getText()});
//          if (error_type_found == Constants.CRITICAL_ERROR)
//            showErrorDialog (NO_DATA_FOUND);
        }
...
//          error_type_found =
//        	new ControlProgram().doControl (new String[] {jTextField1.getText(),
//              getInfile(), getOutfile(),Integer.toString(ControlProgram.INTRODUKSJONSSTONAD),jTextField2.getText()});
//          if (error_type_found == Constants.CRITICAL_ERROR)
//            showErrorDialog (NO_DATA_FOUND);
//        }
