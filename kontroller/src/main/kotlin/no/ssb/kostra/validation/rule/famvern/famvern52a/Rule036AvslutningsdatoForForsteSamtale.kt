...
class Rule036AvslutningsdatoForForsteSamtale :
        ...
        context
            .filter {
                ...
                it.fieldAs<LocalDate?>(FORSTE_SAMT_A_COL_NAME) != null &&
                    ...
                    it.fieldAs<LocalDate>(FORSTE_SAMT_A_COL_NAME) <=
                    it.fieldAs<LocalDate>(
                        DATO_AVSL_A_COL_NAME,
                    )
            }.map {
                createValidationReportEntry(
                    messageText =
                        "Dato for avslutting av saken '${it[DATO_AVSL_A_COL_NAME]}' kommer " +
