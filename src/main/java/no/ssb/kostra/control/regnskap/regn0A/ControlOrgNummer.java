...
final class ControlOrgNummer extends no.ssb.kostra.control.Control
{
  ...
  {
    String orgNum = no.ssb.kostra.control.regnskap.regn0A.RecordFields.getOrgNummer (line);
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    if (numOfRecords > 0)
    {
      ...
      errorReport += lf + "\tKorreksjon: Rett opp i fila slik at skjema 0A ikke har organisasjonsnummer i felt 5." + lf + lf;
    }
    return errorReport;
  }
