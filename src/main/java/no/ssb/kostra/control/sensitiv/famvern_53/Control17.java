...
{
  private final String ERROR_TEXT = "K17: Kurs/undervisning for hjelpeapparatet, timer";
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    if (foundError())
    {
      ...
      "\t'Kurs/undervisning for hjelpeapparatet', til tross for at det er oppgitt antall tiltak.";
      if (numOfRecords <= 10)
      {
