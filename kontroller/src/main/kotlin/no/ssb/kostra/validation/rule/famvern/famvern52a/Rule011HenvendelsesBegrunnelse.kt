...
class Rule011HenvendelsesBegrunnelse :
        ...
        context
            ...
            .map {
                createValidationReportEntry(
                    messageText =
                        "Dette er ikke oppgitt hva som er primærklientens viktigste ønsker med kontakten, eller " +
    ...
    companion object {
        private val fieldDefinition =
            fieldDefinitions.byColumnName(HENV_GRUNN_A_COL_NAME)
    }
}
