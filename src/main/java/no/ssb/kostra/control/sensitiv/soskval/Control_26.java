...
public final class Control_26 extends no.ssb.kostra.control.Control
    implements no.ssb.kostra.control.SingleRecordErrorReport
{
  private final String ERROR_TEXT = 
      "K26: Mottatt økonomisk sosialhjelp, kommunal bostøtte eller " +
      "Husbankens bostøtte i tillegg til kvalifiseringsstønad i løpet av " + Constants.kostraYear;
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    {      
      errorReport += lf + "\tFeil (i " + numOfRecords + 
          " record" + (numOfRecords == 1 ? "" : "s") + "): Feltet for \"Har " +
