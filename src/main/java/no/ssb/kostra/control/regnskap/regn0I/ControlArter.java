...
final class ControlArter extends no.ssb.kostra.control.Control {
	private String[] validArter = { "010", "020", "030", "040", "050", "070",
			...
			"580", "589", "590", "600", "620", "629", "630", "640", "650",
			"660", "670", "690", "700", "710", "729", "730", "750", "770",
			"775", "780", "810", "830", "850", "880", "890", "895", "900",
			"901", "905", "909", "910", "911", "920", "921", "929", "930",
			"940", "948", "950", "958", "970", "980", "989", "990" };
	...
	public boolean doControl(String line, int lineNumber, String region, String statistiskEnhet) {
		...
		if (lineHasError) {
			...
			container[1] = art;
/*
			if (!(art.equalsIgnoreCase("800") || art.equalsIgnoreCase("870")
					|| art.equalsIgnoreCase("874") || art
...
//		}
	...
	public String getErrorReport(int totalLineNumber) {
		String errorReport = "Kontroll 8, Ugyldig bruk av arter:" + lf + lf;
		...
		errorReport += lf + "Korreksjon: Rett opp feil art med gyldig art. For oversikt over gyldige arter se gjeldende versjonav KOSTRA-kontoplanen."
				+ lf + lf;
		return errorReport;
	}
