...
public class TestGui4 extends javax.swing.JFrame
{
    ...
    public TestGui4()
    {
        ...
        jComboBox2.addItem("0S");
        jComboBox2.addItem("0T");
        jComboBox2.addItem("0U");
        jComboBox2.addItem("0V");
        jComboBox2.addItem("0W");
...
//	      jTextField3.setText("C:\\PC\\Skrivebord\\RAZ_Test_oksoshj_kombo_husb_stotte.txt");
//	      jTextField3.setText("Q:\\DOK\\KOSTRA\\KOSTRA-kommune og Fylkes-KOSTRA\\Arbeidsområde\\Filuttrekk\\Kravspec\\Kontrollprogram\\Kvalifiseringsstånad (skjema 11C)\\2013\\Test_oksoshj_kombo_husb_stotte_mfeil");
//	      jTextField4.setText("Q:\\DOK\\KOSTRA\\KOSTRA-kommune og Fylkes-KOSTRA\\Arbeidsområde\\Filuttrekk\\Kravspec\\Kontrollprogram\\test_raz");
//	      jComboBox1.setSelectedItem("Kvalifiseringsstønad 11C");
//	      jComboBox2.setSelectedItem("0C");
//	      jButton3.requestFocus();

//         jTextField1.setText("120000");
//         jTextField3.setText("C:\\Documents and Settings\\ojj\\Mine dokumenter\\kostra\\speshelse\\Test_0T.txt");
//         jTextField4.setText("Q:\\DOK\\KOSTRA\\KOSTRA-kommune og Fylkes-KOSTRA\\Arbeidsområde\\Filuttrekk\\Kravspec\\Kontrollprogram\\test_ojj");
//         jComboBox1.setSelectedItem("Årsregnskap");
//         jComboBox2.setSelectedItem("0T");
//         jButton3.requestFocus();
  ...
  private void initComponents() {
    ...
    txtKontorNr = new javax.swing.JTextField("");
  ...
  private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
    if (jComboBox1.getItemAt(jComboBox1.getSelectedIndex()) != null) {
      jComboBox2.setVisible(((String)jComboBox1.getItemAt(jComboBox1.getSelectedIndex())).equalsIgnoreCase("Årsregnskap"));
      jComboBox3.setVisible(((String)jComboBox1.getItemAt(jComboBox1.getSelectedIndex())).equalsIgnoreCase("Kvartalsregnskap"));
      jComboBox4.setVisible(((String)jComboBox1.getItemAt(jComboBox1.getSelectedIndex())).equalsIgnoreCase("Kvartalsregnskap"));
      jLabel2.setVisible(((String)jComboBox1.getItemAt(jComboBox1.getSelectedIndex())).startsWith("Familievern"));
      txtKontorNr.setVisible(((String)jComboBox1.getItemAt(jComboBox1.getSelectedIndex())).startsWith("Familievern"));
    }
...
//          error_type_found =
        	new ControlProgram().doControl (new String[] {jTextField1.getText(),
              getInfile(), getOutfile(),Integer.toString(ControlProgram.REGNSKAP),(String)jComboBox2.getSelectedItem()});
...
//          error_type_found =
        	new ControlProgram().doControl (new String[] {jTextField1.getText(),
              getInfile(), getOutfile(),Integer.toString(ControlProgram.REGNSKAP),(String)jComboBox3.getSelectedItem()+"K"+((String)jComboBox4.getSelectedItem()).substring(0,1)});
//          if (error_type_found == Constants.CRITICAL_ERROR)
//            showErrorDialog (NO_DATA_FOUND);
        }
...
//          error_type_found =
        	new ControlProgram().doControl (new String[] {jTextField1.getText(),
              getInfile(), getOutfile(),Integer.toString(ControlProgram.SOSIALHJELP)});
//          if (error_type_found == Constants.CRITICAL_ERROR)
//            showErrorDialog (NO_DATA_FOUND);
        }
//        else if (((String)jComboBox1.getSelectedItem()).equalsIgnoreCase("Introduksjonsstønad 11B"))
//        {
//          error_type_found =
//        	new ControlProgram().doControl (new String[] {jTextField1.getText(),
//              getInfile(), getOutfile(),Integer.toString(ControlProgram.INTRODUKSJONSSTONAD)});
//          if (error_type_found == Constants.CRITICAL_ERROR)
//            showErrorDialog (NO_DATA_FOUND);
//        }
...
//          error_type_found =
        	new ControlProgram().doControl (new String[] {jTextField1.getText(),
              getInfile(), getOutfile(),Integer.toString(ControlProgram.KVALIFISERINGSSTONAD)});
//          if (error_type_found == Constants.CRITICAL_ERROR)
//            showErrorDialog (NO_DATA_FOUND);
        }
...
//          error_type_found =
        	new ControlProgram().doControl (new String[] {jTextField1.getText(),
              getInfile(), getOutfile(),Integer.toString(ControlProgram.BARNEVERN)});
//          if (error_type_found == Constants.CRITICAL_ERROR)
//            showErrorDialog (NO_DATA_FOUND);
        }
...
//          error_type_found =
        	new ControlProgram().doControl (new String[] {jTextField1.getText(),
              getInfile(), getOutfile(),Integer.toString(ControlProgram.VAR_26)});
//          if (error_type_found == Constants.CRITICAL_ERROR)
//            showErrorDialog (NO_DATA_FOUND);
        }
...
//          error_type_found =
        	new ControlProgram().doControl (new String[] {jTextField1.getText(),
              getInfile(), getOutfile(),Integer.toString(ControlProgram.FAMILIEVERN), txtKontorNr.getText()});
        }
        else if (((String)jComboBox1.getSelectedItem()).equalsIgnoreCase("Familievern 52B"))
        {
//          error_type_found =
        	new ControlProgram().doControl (new String[] {jTextField1.getText(),
              getInfile(), getOutfile(),Integer.toString(ControlProgram.FAMILIEVERN_B), txtKontorNr.getText()});
        }
        else if (((String)jComboBox1.getSelectedItem()).equalsIgnoreCase("Familievern 53"))
        {
//          error_type_found =
        	new ControlProgram().doControl (new String[] {jTextField1.getText(),
              getInfile(), getOutfile(),Integer.toString(ControlProgram.FAMILIEVERN_53), txtKontorNr.getText()});
        }
        else if (((String)jComboBox1.getSelectedItem()).equalsIgnoreCase("Meklinger 55"))
        {
//          error_type_found =
        	new ControlProgram().doControl (new String[] {jTextField1.getText(),
              getInfile(), getOutfile(),Integer.toString(ControlProgram.Meklinger_55)});
...
//        fc.setCurrentDirectory(new File("Q:/DOK/KOSTRA/StatsKOSTRA/Helseforetak/Kravspesifikasjon2011/Tilleggsskjema Testfiler"));
  ...
  private javax.swing.JTextField txtKontorNr;
