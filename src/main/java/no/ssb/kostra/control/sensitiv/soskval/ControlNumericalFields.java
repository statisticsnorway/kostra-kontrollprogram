 ...
 * Revision 1.2  2010/10/18 12:31:06  pll
 * Klar for 2010-rapp.
 *
 * Revision 1.1  2009/09/30 06:22:26  pll
 * Import.
 *
 * 
 */
...
{
  private final String ERROR_TEXT = "K2: Ugyldige tegn i tallfelt";
  private Vector<Integer> lineNumbers = new Vector<Integer>();

  public boolean doControl(String line, int lineNumber, String region, String statistiskEnhet)
  {    
    String concatenatedNumericalFields = RecordFields.getAllNumericalFieldsConcatenated(line);
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    errorReport += "\tDet forekommer andre tegn enn tallene 0 til 9, 01 til 18 eller " +
