...
{
  private final String ERROR_TEXT = "K11: Andre tiltak mot publikum, timer";
  private Vector<Integer> lineNumbers = new Vector<Integer>();

  public boolean doControl(String line, int lineNumber, String region, String statistiskEnhet)
  {
    boolean lineHasError; 
    String fieldValue = RecordFields.getFieldValue(line, 52);
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    if (foundError())
    {
      ...
      "\t'Andre tiltak mot publikum', til tross for at det er oppgitt antall tiltak.";
      if (numOfRecords <= 10)
      {
