...
| `FORMELL_SIVILS_A` | Om samboer eller Lever ikke i samliv skal det krysses av for sivilstand | 1 | 35‑35 | STRING_TYPE | ☑️ |  | `1`: Ugift<br/>`2`: Gift<br/>`3`: Registrert partner<br/>`4`: Separert / separert partner<br/>`5`: Skilt / skilt partner<br/>`6`: Enke / enkemann / gjenlevende partner |
