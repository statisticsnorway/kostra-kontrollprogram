...
class Rule015ViktigsteKildeTilLivsOppholdKode1 : AbstractNoArgsRule<List<KostraRecord>>(
        ...
        .map {
            createValidationReportEntry(
                "Mottakerens viktigste kilde til livsopphold ved siste kontakt med sosial-/NAV-kontoret " +
                        ...
                        "(${fieldDefinitions.byColumnName(ARBSIT_COL_NAME).codeList.filter { item -> item.code in validCodes }})'. " +
