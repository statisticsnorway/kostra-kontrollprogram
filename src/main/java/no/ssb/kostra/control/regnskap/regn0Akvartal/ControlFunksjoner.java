	...
	private String[] validFunksjonerForOsloKommuner =
		{
			...
			"526", "527", "528", "529", "530", "531", "532", "533",
			"554", "559", "561", "562", "570", "581", "590", "660",
			"665", "691", "692", "693", "694", "696", "700", "705",
			"710", "711", "715", "716", "722", "730", "731", "732",
			"733", "734", "740", "750", "760", "771", "772", "775",
			"790", "800", "840", "841", "850", "860", "870", "880",
			"899", "z"
		};

	private Vector<String[]> invalidFunksjoner = new Vector<String[]>();
	private Vector<String[]> invalidFunksjonerForSpecialKommune = new Vector<String[]>();
	private Vector<String[]> invalidFunksjonerForOsloKommune = new Vector<String[]>();
	...
	public String getErrorReport(int totalLineNumber) {
		...
		if (numOfRecords > 0) {
			errorReport += "\tFeil: Ukjent" + (numOfRecords == 1 ? "" : "e")
					+ " funksjon" + (numOfRecords == 1 ? "" : "er") + ":" + lf;
			for (int i = 0; i < numOfRecords; i++) {
				String[] container = (String[]) invalidFunksjonerForSpecialKommune
						.elementAt(i);
				errorReport += "\t\tfunksjon " + container[1] + " (Record nr. "
						+ container[0] + ")" + lf;
			}
		...
		if (numOfRecords > 0) {
			errorReport += "\tFeil: Ukjent" + (numOfRecords == 1 ? "" : "e")
					+ " funksjon" + (numOfRecords == 1 ? "" : "er") + ":" + lf;
			for (int i = 0; i < numOfRecords; i++) {
				String[] container = (String[]) invalidFunksjonerForOsloKommune
						.elementAt(i);
				errorReport += "\t\tfunksjon " + container[1] + " (Record nr. "
						+ container[0] + ")" + lf;
			}
