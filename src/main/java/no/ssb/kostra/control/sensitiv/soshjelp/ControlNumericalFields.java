    ...
    implements no.ssb.kostra.control.SingleRecordErrorReport
{
  ...
  public boolean doControl(String line, int lineNumber, String region, String statistiskEnhet)
  {
    String concatenatedNumericalFields = 
        line.substring(0,8) + line.substring(18, 29) + line.substring(41,259) + line.substring(269, 272) + line.substring(284, 314);
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    errorReport += "\tDet forekommer andre tegn enn tallene 0 til 9, 01 til 12 eller " +
