...
{
  private final String ERROR_TEXT = "K13: Undervisning/veiledning studenter, timer";
  private Vector<Integer> lineNumbers = new Vector<Integer>();

  public boolean doControl(String line, int lineNumber, String region, String statistiskEnhet)
  {
    boolean lineHasError; 
    String fieldValue = RecordFields.getFieldValue(line, 62);
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    if (foundError())
    {
      ...
      "\t'Undervisning/veiledning studenter', til tross for at det er oppgitt antall tiltak.";
      if (numOfRecords <= 10)
      {
