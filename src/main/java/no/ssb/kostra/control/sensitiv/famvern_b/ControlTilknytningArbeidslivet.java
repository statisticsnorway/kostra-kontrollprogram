...
public final class ControlTilknytningArbeidslivet extends no.ssb.kostra.control.Control
    implements no.ssb.kostra.control.SingleRecordErrorReport
{
  private final String ERROR_TEXT = "K21: Deltakerens tilknytning til arbeidslivet";
  private Vector<Integer> lineNumbers = new Vector<Integer>();

  public boolean doControl(String line, int lineNumber, String region, String statistiskEnhet)
  {
    String fieldValue = RecordFields.getFieldValue(line, 18);
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    if (foundError())
    {
      ...
      "\tved sakens opprettelse eller feil kode er benyttet. Feltet er obligatorisk å fylle ut."; 
      if (numOfRecords <= 10)
      {
