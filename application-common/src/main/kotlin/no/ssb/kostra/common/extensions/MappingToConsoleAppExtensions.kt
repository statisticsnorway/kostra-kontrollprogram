...
private fun KostraFormVm.toArgumentList() = mutableMapOf(
    ...
    NAME_ABBR to (this.navn ?: no.ssb.kostra.common.extensions.NAME_FALLBACK_VALUE)
).also { parameterMap ->
    ...
    if (this.orgnrVirksomhet.any()) {
        parameterMap[UNIT_ORGNR_ABBR] = this.orgnrVirksomhet.joinToString(separator = no.ssb.kostra.common.extensions.SEPARATOR_CHAR) { it.orgnr }
    }
