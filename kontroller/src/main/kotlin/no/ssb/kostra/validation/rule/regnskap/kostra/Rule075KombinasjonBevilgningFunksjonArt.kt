...
class Rule075KombinasjonBevilgningFunksjonArt :
    ...
    override fun validate(
        ...
        .filter { kostraRecord ->
            kostraRecord.isBevilgningRegnskap() && kostraRecord.isKommuneRegnskap() &&
            ...
            createValidationReportEntry(
                messageText =
                    "Artene ${qualifyingArtCodes.joinToString(", ")} er kun tillat brukt i " +
    ...
    companion object {
        internal val qualifyingArtCodes =
            setOf("870", "871", "872", "873", "876", "878", "879")
