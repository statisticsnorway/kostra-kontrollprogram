    ...
    extends no.ssb.kostra.control.Control
{
  ...
  {
    String errorReport = "Kontroll 24a, Kombinasjon, funksjon og art:" + lf + lf;
    if (foundError())
    {
    ...
    errorReport += lf + "\tKorreksjon: Rett opp feil kontoklasse eller funksjon. I driftsregnskapet skal" + lf +
    		            "\tmva-kompensasjon (art 729) føres på funksjonen hvor utgiften oppstod." + lf + lf;
    return errorReport;
  }
