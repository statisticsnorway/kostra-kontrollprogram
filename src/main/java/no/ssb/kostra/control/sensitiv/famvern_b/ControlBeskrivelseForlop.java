...
/*
 * $Log: ControlBeskrivelseForlop.java,v $
...
public final class ControlBeskrivelseForlop extends no.ssb.kostra.control.Control
    implements no.ssb.kostra.control.SingleRecordErrorReport
{
  private final String ERROR_TEXT = "K15: Beskrivelse av problemstillingens forløp";
  private Vector<Integer> lineNumbers = new Vector<Integer>();

  public boolean doControl(String line, int lineNumber, String region, String statistiskEnhet)
  {
    String viktigsteGrunn = RecordFields.getFieldValue(line, 13);
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    if (foundError())
    {
      ...
      " er det ikke oppgitt hvordan deltakeren vil beskrive problemstillingens forløp, " + lf +
