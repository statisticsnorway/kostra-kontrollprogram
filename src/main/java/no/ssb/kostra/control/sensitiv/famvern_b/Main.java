...
public final class Main
{
  ...
  private final String VERSION = "52B." + Constants.kostraYear + ".01";
  ...
  public int start() throws Exception
  {
          ...
          if (! controls[0].doControl(line, lineNumber, regionNumber, ""))
          {
            ...
            for (int i=1; i<controls.length; i++)
            {
              if (controls[i].doControl(line, lineNumber, regionNumber, ""))
              {
                ...
                container[1] = RecordFields.getGruppeNr(line) + "  ";
    ...
    try
    {
      ...
      report.append ( "Type filuttrekk: Familievern " + Constants.kostraYear + lf + lf);
      ...
      if (numOfErrors > 0)
      {
        ...
        if (errorLinesSize > 0)
        {
          ...
          report.append ( lf + "Opplisting av feil pr. record (recordnr., gruppenr., kontrolltekst):" + lf +
                         "---------------------------------------------------------------------" + lf + lf);
  ...
  private void initControls()
  {
	    ...
	    controls[6] = new ControlGruppenavn();
	    controls[7] = new ControlDatoStartGruppebehandling();
	    controls[8] = new ControlMaalGruppe();
	    controls[9] = new ControlHovedinnholdGruppe();
	    controls[10] = new ControlAntallGruppeMoterGjennomfortAar();
	    controls[11] = new ControlAntallGruppeMoterTotalt();
	    controls[12] = new ControlAntallTimerAnvendtGruppeAar();
	    controls[13] = new ControlAntallTimerAnvendtGruppeTotalt();
	    controls[14] = new ControlAntallDeltakereGruppeAar();
	    controls[15] = new ControlAntallDeltakereGruppeTotalt();
	    controls[16] = new ControlAntallTerapeuter();
	    controls[17] = new ControlTolk();
	    controls[18] = new ControlStatusAaretsSlutt();
	    controls[19] = new ControlAvslutningsDato();
	    controls[20] = new ControlAvslDatoFoerForsteGruppeMote();
  }
}
