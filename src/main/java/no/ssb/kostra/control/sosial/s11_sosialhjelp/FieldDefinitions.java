    ...
    public static List<FieldDefinition> getFieldDefinitions() {
        return List.of(
                ...
                new FieldDefinition(251, "VILKARARBEID",
                        ...
                        "checkBox",
                        285, 286,
                        List.of(new Code("16", "Delta på arbeidstrening/arbeidspraksis")),
                        "",
                        false),
                new FieldDefinition(252, "VILKARKURS",
                        ...
                        "checkBox",
                        287, 288,
                        List.of(new Code("17", "Delta på arbeidsrettede kurs, opplæring eller jobbsøkingskurs")),
                        "",
                        false),
                new FieldDefinition(254, "VILKARUTD",
                        ...
                        "checkBox",
                        289, 290,
                        List.of(new Code("04", "Benytte rett til skole")),
                        "",
                        false),
                new FieldDefinition(256, "VILKARJOBBLOG",
                        ...
                        "checkBox",
                        291, 292,
                        List.of(new Code("06", "Registrere seg som arbeidssøker/føre jobblogg")),
                        "",
                        false),
                new FieldDefinition(257, "VILKARJOBBTILB",
                        ...
                        "checkBox",
                        293, 294,
                        List.of(new Code("07", "Ta imot et konkret jobbtilbud")),
                        "",
                        false),
                new FieldDefinition(258, "VILKARSAMT",
                        ...
                        "checkBox",
                        295, 296,
                        List.of(new Code("08", "Møte til veiledningssamtaler")),
                        "",
                        false),
                new FieldDefinition(2510, "VILKAROKRETT",
                        ...
                        "checkBox",
                        297, 298,
                        List.of(new Code("10", "Gjøre gjeldende andre økonomiske rettigheter")),
                        "",
                        false),
                new FieldDefinition(2511, "VILKARLIVSH",
                        ...
                        "checkBox",
                        299, 300,
                        List.of(new Code("18", "Realisere formuesgoder/ redusere boutgifter")),
                        "",
                        false),
                new FieldDefinition(2514, "VILKARHELSE",
                        ...
                        "checkBox",
                        301, 302,
                        List.of(new Code("14", "Oppsøke helsetjenester/ lege")),
                        "",
                        false),
                ...
                new FieldDefinition(2516, "VILKARDIGPLAN",
                        ...
                        "checkBox",
                        305, 306,
                        List.of(new Code("19", "Bruke og følge opp digital aktivitetsplan")),
                        "",
                        false),
                ...
                new FieldDefinition(271, "VEDTAKARB",
                        ...
                        "checkBox",
                        313, 314,
                        List.of(new Code("01", "Mottaker er i arbeid")),
                        "",
                        false),
                new FieldDefinition(272, "VEDTAKAKT",
                        ...
                        "checkBox",
                        315, 316,
                        List.of(new Code("02", "Mottaker er allerede i aktivitet knyttet til mottak av statlig eller annen kommunal ytelse")),
                        "",
                        false),
                new FieldDefinition(273, "VEDTAKHELSE",
                        ...
                        "checkBox",
                        317, 318,
                        List.of(new Code("03", "Mottakers helsemessige eller sosiale situasjon hindrer deltakelse i aktivitet")),
                        "",
                        false),
                new FieldDefinition(274, "VEDTAKGRUNN",
                        ...
                        "checkBox",
                        319, 320,
                        List.of(new Code("04", "Andre tungtveiende grunner taler mot at det stilles vilkår om aktivitet")),
                        "",
                        false),
                new FieldDefinition(281, "SANKSJONRED",
                        ...
                        "checkBox",
                        321, 322,
                        List.of(new Code("01", "Redusert stønad")),
                        "",
                        false),
                new FieldDefinition(282, "SANKSJONANDRE",
                        ...
                        "checkBox",
                        323, 324,
                        List.of(new Code("02", "Andre konsekvenser")),
                        "",
                        false)
        );
    }
