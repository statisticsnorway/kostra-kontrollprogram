...
class Control11Bu18AntBu18 : AbstractRule<KostraRecord>(
    ...
    override fun validate(context: KostraRecord, arguments: KotlinArguments): List<ValidationReportEntry>? {
        ...
        return if (bu18Checked && numberOfChildren < 1) {
            createSingleReportEntryList(
                "Det er krysset av for at det bor barn under 18 år i husholdningen som mottaker eller " +
                        "ektefelle/samboer har forsørgerplikt for, men det er ikke oppgitt hvor mange barn '($numberOfChildren)' " +
                        "som bor i husholdningen. Feltet er obligatorisk å fylle ut når det er oppgitt at det bor barn " +
                        "under 18 år i husholdningen."
            )
        } else null
    }
}