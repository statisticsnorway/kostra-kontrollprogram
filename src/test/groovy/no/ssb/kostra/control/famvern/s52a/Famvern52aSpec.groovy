...
class Famvern52aSpec extends Specification {
    ...
    def "K03, kontrollere regionnummer REGION_NR_A, #region_nr_a -> #hasError -> #errorlevel"() {
        given:
        def record = new KostraRecord(Map.of("REGION_NR_A", region_nr_a, "KONTOR_NR_A", kontor_nr_a), fieldDefinitions)
    ...
    def "K07 Henvendelsesdato '#henv_dato_a' -> #hasError -> #errorlevel"() {
        given:
        def record = new KostraRecord(Map.of("REGION_NR_A", region_nr_a, "KONTOR_NR_A", kontor_nr_a, "HENV_DATO_A", henv_dato_a), fieldDefinitions)
    ...
    def "K09 Kontakt tidligere '#kontakt_tidl_a' -> #hasError -> #errorlevel"() {
        given:
        def record = new KostraRecord(Map.of("REGION_NR_A", region_nr_a, "KONTOR_NR_A", kontor_nr_a, "KONTAKT_TIDL_A", kontakt_tidl_a), fieldDefinitions)
    ...
    def "K11 Henvendelses begrunnelse '#henv_grunn_a' -> #hasError -> #errorlevel"() {
        given:
        def record = new KostraRecord(Map.of("REGION_NR_A", region_nr_a, "KONTOR_NR_A", kontor_nr_a, "HENV_GRUNN_A", henv_grunn_a), fieldDefinitions)
    ...
    def "K13 Kjonn '#primk_kjonn_a' -> #hasError -> #errorlevel"() {
        given:
        def record = new KostraRecord(Map.of("REGION_NR_A", region_nr_a, "KONTOR_NR_A", kontor_nr_a, "PRIMK_KJONN_A", primk_kjonn_a), fieldDefinitions)
    ...
    def "K14 Fodselsaar '#primk_fodt_a' -> #hasError -> #errorlevel"() {
        given:
        def record = new KostraRecord(Map.of("REGION_NR_A", region_nr_a, "KONTOR_NR_A", kontor_nr_a, "PRIMK_FODT_A", primk_fodt_a), fieldDefinitions)
    ...
    def "K15 Samlivsstatus '#primk_sivils_a' -> #hasError -> #errorlevel"() {
        given:
        def record = new KostraRecord(Map.of("REGION_NR_A", region_nr_a, "KONTOR_NR_A", kontor_nr_a, "PRIMK_SIVILS_A", primk_sivils_a), fieldDefinitions)
    ...
    def "K16 Formell sivilstand '#primk_sivils_a' / '#formell_sivils_a' -> #hasError -> #errorlevel"() {
        given:
        def record = new KostraRecord(Map.of("REGION_NR_A", region_nr_a, "KONTOR_NR_A", kontor_nr_a, "PRIMK_SIVILS_A", primk_sivils_a, "FORMELL_SIVILS_A", formell_sivils_a), fieldDefinitions)
    ...
    def "K17 Bosituasjon '#primk_sambo_a' -> #hasError -> #errorlevel"() {
        given:
        def record = new KostraRecord(Map.of("REGION_NR_A", region_nr_a, "KONTOR_NR_A", kontor_nr_a, "PRIMK_SAMBO_A", primk_sambo_a), fieldDefinitions)
    ...
    def "K18 Arbeidssituasjon '#primk_arbsit_a' -> #hasError -> #errorlevel"() {
        given:
        def record = new KostraRecord(Map.of("REGION_NR_A", region_nr_a, "KONTOR_NR_A", kontor_nr_a, "PRIMK_ARBSIT_A", primk_arbsit_a), fieldDefinitions)
    ...
    def "K19A Varighet samtalepartner '#primk_vsrelasj_a' / '#part_lengde_a' -> #hasError -> #errorlevel"() {
        given:
        def record = new KostraRecord(Map.of("REGION_NR_A", region_nr_a, "KONTOR_NR_A", kontor_nr_a, "PRIMK_VSRELASJ_A", primk_vsrelasj_a, "PART_LENGDE_A", part_lengde_a), fieldDefinitions)
    ...
    def "K19B1 Varighet siden brudd '#primk_vsrelasj_a' / '#ekspart_lengde_a' -> #hasError -> #errorlevel"() {
        given:
        def record = new KostraRecord(Map.of("REGION_NR_A", region_nr_a, "KONTOR_NR_A", kontor_nr_a, "PRIMK_VSRELASJ_A", primk_vsrelasj_a, "EKSPART_LENGDE_A", ekspart_lengde_a), fieldDefinitions)
    ...
    def "K19B2 Varighet ekspartner '#primk_vsrelasj_a' / '#ekspart_varigh_a' -> #hasError -> #errorlevel"() {
        given:
        def record = new KostraRecord(Map.of("REGION_NR_A", region_nr_a, "KONTOR_NR_A", kontor_nr_a, "PRIMK_VSRELASJ_A", primk_vsrelasj_a, "EKSPART_VARIGH_A", ekspart_varigh_a), fieldDefinitions)
    ...
    def "K20 Dato forste behandlingssamtale '#forste_samt_a' -> #hasError -> #errorlevel"() {
        given:
        def record = new KostraRecord(Map.of("REGION_NR_A", region_nr_a, "KONTOR_NR_A", kontor_nr_a, "FORSTE_SAMT_A", forste_samt_a), fieldDefinitions)
    ...
    def "K21 Dato forste behandlingssamtale er etter henvendelsesdato '#henv_dato_a' / '#forste_samt_a' -> #hasError -> #errorlevel"() {
        given:
        def record = new KostraRecord(Map.of("REGION_NR_A", region_nr_a, "KONTOR_NR_A", kontor_nr_a, "HENV_DATO_A", henv_dato_a, "FORSTE_SAMT_A", forste_samt_a), fieldDefinitions)
