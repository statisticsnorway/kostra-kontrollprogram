...
public final class Control22
        extends no.ssb.kostra.control.Control
        implements no.ssb.kostra.control.SingleRecordErrorReport {
    private final String ERROR_TEXT = "K22: Foreldreveiledning, tiltak";
    private List<Integer> lineNumbers = new ArrayList<>();

    @Override
    public boolean doControl(String line, int lineNumber, String region, String statistiskEnhet) {
        boolean lineHasError;
        String tiltak = RecordFields.getFieldValue(line, 111);
    ...
    public String getErrorReport(int totalLineNumber) {
        ...
        if (foundError()) {
            ...
            errorReport += "\tFeil: i " + numOfRecords +
                    ...
                    "'Foreldreveiledning, tiltak'. Sjekk om det er glemt å rapportere 'Foreldreveiledning, tiltak'.";
            if (numOfRecords <= 10) {
