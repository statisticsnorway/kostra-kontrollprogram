...
class Control023TilknytningTilTrygdesystemetOgBarnTest : BehaviorSpec({
    include(
        KostraTestFactory.validationRuleTest(
            sut = Control023TilknytningTilTrygdesystemetOgBarn(),
            forAllRows = listOf(
                ForAllRowItem(
    ...
    companion object {
        private fun kostraRecordInTest(
            ...
            mapOf(
                ...
                SosialColumnNames.HAR_BARN_UNDER_18_COL_NAME to harBarn,
                SosialColumnNames.ANT_BARN_UNDER_18_COL_NAME to antBarn
            )
        )
    }
}