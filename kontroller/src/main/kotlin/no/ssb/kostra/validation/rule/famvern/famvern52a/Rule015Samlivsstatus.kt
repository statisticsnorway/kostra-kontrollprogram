...
class Rule015Samlivsstatus :
        ...
        context
            ...
            .map {
                createValidationReportEntry(
                    messageText =
                        "Primærklientens samlivsstatus ved sakens opprettelse er ikke fylt ut eller feil kode " +
    ...
    companion object {
        private val fieldDefinition =
            fieldDefinitions.byColumnName(PRIMK_SIVILS_A_COL_NAME)
    }
}
