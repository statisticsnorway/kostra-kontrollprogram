...
final class ControlOrgNummer extends no.ssb.kostra.control.Control
{
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    if (numOfRecords > 0)
    {
      errorReport += "\tFeil: Mangler organisasjonsnummer eller oppgitt organisasjonsnummer er ikke korrekt i hht. Brønnøysundregisterets opplysninger pr oktober " + Constants.kostraYear + "." + lf +
