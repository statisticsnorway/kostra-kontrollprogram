...
class Rule540EiendelerErLikEgenkaptialPlussGjeldTest : BehaviorSpec({
    ...
    Given("context") {
        forAll(
            ...
            row("0Y", "1000", "0", "0", true), // belop mismatch -> OK
            row("0Y", "0", "-500", "0", true), // belop mismatch -> OK
            row("0Y", "0", "0", "-500", true), // belop mismatch -> OK
            row("0Y", "1000", "-500", "0", true), // belop mismatch -> OK
            row("0Y", "1000", "0", "-500", true), // belop mismatch -> OK
