...
class Control19KvalifiseringsprogramIAnnenKommune : AbstractRule<KostraRecord>(
    ...
    override fun validate(context: KostraRecord, arguments: KotlinArguments) = context[KVP_KOMM_COL_NAME]
        .takeIf { fieldDefinitions.byColumnName(KVP_KOMM_COL_NAME).codeIsMissing(it) }
        ?.let {
