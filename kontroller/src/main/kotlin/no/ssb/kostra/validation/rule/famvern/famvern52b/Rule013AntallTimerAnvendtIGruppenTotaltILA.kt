...
class Rule013AntallTimerAnvendtIGruppenTotaltILA :
    ...
    override fun validate(context: List<KostraRecord>) =
        context
            .filterNot { 0 < it.fieldAsIntOrDefault(TIMERTOT_IARET_B_COL_NAME) }
            .map {
                createValidationReportEntry(
                    messageText =
                        "Det er ikke fylt ut hvor mange timer som er anvendt for gruppen " +
