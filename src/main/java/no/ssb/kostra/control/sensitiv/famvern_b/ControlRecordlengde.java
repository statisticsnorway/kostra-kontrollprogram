    ...
    implements no.ssb.kostra.control.SingleRecordErrorReport
{
  ...
  private final int RECORD_LENGTH = 85;
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    if (foundError())
    {
      ...
      errorReport += "\tFeil: Lengden på recorden (filuttrekket) stemmer ikke med det antall posisjoner som er oppgitt i filbeskrivelsen " + numOfRecords + 
