...
/*
 * $Log: ControlErDeltakerPrimarklient.java,v $
 * Revision 1.1  2009/01/06 09:21:01  pll
 * Import.
 *
...
public final class ControlErDeltakerPrimarklient extends no.ssb.kostra.control.Control
    implements no.ssb.kostra.control.SingleRecordErrorReport
{
  private final String ERROR_TEXT = "K10: Er deltakeren primærklient i saken?";
  private Vector<Integer> lineNumbers = new Vector<Integer>();

  public boolean doControl(String line, int lineNumber, String region, String statistiskEnhet)
  {
    String viktigsteGrunn = RecordFields.getFieldValue(line, 8);
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    if (foundError())
    {
      ...
      " er det ikke krysset av for hva som har vært hovedinnhold/tema i gruppen, " + lf +
