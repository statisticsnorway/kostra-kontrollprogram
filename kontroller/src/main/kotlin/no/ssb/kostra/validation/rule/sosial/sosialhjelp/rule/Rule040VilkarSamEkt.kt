...
class Rule040VilkarSamEkt : AbstractNoArgsRule<List<KostraRecord>>(
    SosialhjelpRuleId.SOSIALHJELP_K040_VILKARSAMEKT.title,
    Severity.ERROR
) {
    override fun validate(context: List<KostraRecord>) = context
        .filterNot { fieldDefinition.codeExists(it[VILKARSAMEKT_COL_NAME]) }
        .map {
    ...
    companion object {
        private val fieldDefinition = fieldDefinitions.byColumnName(VILKARSAMEKT_COL_NAME)
    }
}