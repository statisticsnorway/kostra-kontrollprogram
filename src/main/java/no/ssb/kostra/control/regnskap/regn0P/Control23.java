...

{
    ...
    public boolean doControl(String line, int lineNumber, String region, String statistiskEnhet) {
        ...
        String funksjon = no.ssb.kostra.control.regnskap.regn0P.RecordFields.getFunksjon(line);
        String art = no.ssb.kostra.control.regnskap.regn0P.RecordFields.getArt(line);
