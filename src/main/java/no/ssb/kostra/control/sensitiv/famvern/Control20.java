...
/*
 * $Log: Control20.java,v $
 * Revision 1.3  2008/12/13 08:28:06  pll
 * no message
 *
...
public final class Control20 extends no.ssb.kostra.control.Control
    implements no.ssb.kostra.control.SingleRecordErrorReport
{
  private final String ERROR_TEXT = "K20: Dato for første behandlingssamtale";
  ...
  public boolean doControl(String line, int lineNumber, String region, String statistiskEnhet)
  {
    ...
    if (CompatJdk13.isNumerical(field_17)) {
        
      int checkValue = 0;
      checkValue = DatoFnr.validDateDDMMYYYY(field_17);
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    if (foundError())
    {
      ...
      " er det ikke oppgitt dato for første behandlingssamtale " + lf + 
