...
class Rule021AvslutningsdatoForForsteSamtaleTest : BehaviorSpec({
    include(
        KostraTestFactory.validationRuleNoContextTest(
            ...
            ForAllRowItem(
                ...
                expectedErrorMessage = "Dato for avslutting av gruppebehandlingen '01012023' kommer " +
                        "før dato for gruppebehandlingens start '02022023'."
            ),
            ForAllRowItem(
                "invalid date, invalid day",
                kostraRecordInTest("32102023", "02022023"),
                expectedErrorMessage = "Dato for avslutting av gruppebehandlingen '02022023' kommer " +
