...
class Rule023HovedformPaaBehandlingstilbudet :
        ...
        context
            ...
            .map {
                createValidationReportEntry(
                    messageText =
                        "Det er ikke krysset av for hva som har vært hovedformen på behandlingstilbudet siden " +
    ...
    companion object {
        private val fieldDefinition =
            fieldDefinitions.byColumnName(HOVEDF_BEHAND_A_COL_NAME)
    }
}
