...
public final class ControlTrygdesystemAlderUnder66 extends no.ssb.kostra.control.Control
    implements no.ssb.kostra.control.SingleRecordErrorReport
{
  ...
  public boolean doControl(String line, int lineNumber, String region, String statistiskEnhet)
  {
    ...
    boolean lineHasError = (alder<=AGE_LIMIT) && field_12.equalsIgnoreCase("07");
