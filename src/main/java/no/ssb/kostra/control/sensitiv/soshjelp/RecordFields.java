...
final class RecordFields 
{
  static String getFieldValue (String record, int fieldNo)
  {
    ...
    switch (fieldNo)
    {
      ...
      case 2511:
        ...
        break;
      case 2512:
        fieldValue = record.substring(306, 308);
        break;
      case 2513:
        fieldValue = record.substring(308, 310);
        break;
      case 2514:
  ...
  {
    //return record.substring(0,8) + record.substring(18,29) + record.substring(258, 259) + record.substring(269, 270);
    return record.substring(0,8) + record.substring(18,29) + record.substring(41, 259) + record.substring(269, 272) + record.substring(284, 314);
  }
