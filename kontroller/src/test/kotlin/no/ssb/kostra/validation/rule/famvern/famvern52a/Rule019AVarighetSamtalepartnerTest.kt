...
class Rule019AVarighetSamtalepartnerTest : BehaviorSpec({
    include(
        KostraTestFactory.validationRuleNoContextTest(
            sut = Rule019AVarighetSamtalepartner(),
            ...
            ForAllRowItem(
                ...
                expectedErrorMessage = "Det er oppgitt at primærklientens relasjon til viktigste deltager er " +
                        "partner, men det er ikke oppgitt hvor lenge partene har vært gift, samboere eller " +
        ...
        private fun kostraRecordInTest(relasjon: String, lengde: String) = listOf(
            Familievern52aTestUtils.familievernRecordInTest(
                mapOf(
                    ...
                    Familievern52aColumnNames.PART_LENGDE_A_COL_NAME to lengde
                )
            )
        )
    }
