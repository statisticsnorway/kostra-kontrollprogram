...
public class ControlFeltInneholderKodeFraKodelisteTest {
    ...
    public void beforeTest() {
        ...
        fieldDefinitions = List.of(
                ...
                new FieldDefinition(3, "felt3", "String", "", 5, 5, new ArrayList<>(), ""),
                new FieldDefinition(4, "heltall", "Integer", "", 6, 10, new ArrayList<>(), "")
        );
    ...
    @Test
    public void testOK() {
        ControlFeltInneholderKodeFraKodeliste.doControl(r, er, ere, "felt1", List.of("F1"));
    ...
    public void testFail() {
        ControlFeltInneholderKodeFraKodeliste.doControl(r, er, ere, "felt1", List.of("FA"));
    ...
    public void testBlank1() {
        ControlFeltInneholderKodeFraKodeliste.doControl(r, er, ere, "felt3", List.of(""));
        assertEquals(Constants.CRITICAL_ERROR, er.getErrorType());
