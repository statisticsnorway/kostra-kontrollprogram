...
class Rule000HasAttachment : AbstractRule<List<String>>("Kontroll 000 : Skal levere filuttrekk", Severity.FATAL) {
    override fun validate(
        context: List<String>,
        arguments: KotlinArguments
    ): List<ValidationReportEntry>? = if (arguments.harVedlegg)
