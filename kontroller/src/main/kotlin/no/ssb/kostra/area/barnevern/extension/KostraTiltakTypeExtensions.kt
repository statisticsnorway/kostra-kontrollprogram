...
import no.ssb.kostra.area.barnevern.SharedValidationConstants.ALLOCATION_CODE_1_PREFIX
import no.ssb.kostra.area.barnevern.SharedValidationConstants.ALLOCATION_CODE_2_PREFIX
import no.ssb.kostra.area.barnevern.SharedValidationConstants.BVL1992
import no.ssb.kostra.area.barnevern.SharedValidationConstants.BVL2021
import no.ssb.kostra.area.barnevern.SharedValidationConstants.KAPITTEL_4
import no.ssb.kostra.area.barnevern.SharedValidationConstants.KAPITTEL_5
import no.ssb.kostra.area.barnevern.SharedValidationConstants.MEASURE_CATEGORY_CODE_8_2
import no.ssb.kostra.area.barnevern.SharedValidationConstants.PARAGRAF_1
import no.ssb.kostra.area.barnevern.SharedValidationConstants.PARAGRAF_12
import no.ssb.kostra.area.barnevern.SharedValidationConstants.PARAGRAF_8
import no.ssb.kostra.area.barnevern.SharedValidationConstants.leddOmsorg
