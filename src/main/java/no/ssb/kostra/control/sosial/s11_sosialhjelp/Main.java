...
public class Main {
    ...
    public static ErrorReport doControls(Arguments arguments) {
        ...
        records.forEach(r -> {
            ...
            control10ForsorgerpliktForBarnUnder18Aar(errorReport, r);
            control11AntallBarnIHusholdningenMangler(errorReport, r);
            control12AntallBarnIHusholdningen(errorReport, r);
            control13MangeBarnIHusholdningen(errorReport, r);
            control14ViktigsteKildeTilLivsoppholdGyldigeVerdier(errorReport, r);
            control15ViktigsteKildeTilLivsopphold(errorReport, r);
            control16ViktigsteKildeTilLivsopphold(errorReport, r);
            control17ViktigsteKildeTilLivsopphold(errorReport, r);
            control18ViktigsteKildeTilLivsopphold(errorReport, r);
            control19ViktigsteKildeTilLivsopphold(errorReport, r);
            control20ViktigsteKildeTilLivsopphold(errorReport, r);
            control22TilknytningTilTrygdesystemetOgAlder(errorReport, r);
            control23TilknytningTilTrygdesystemetOgBarn(errorReport, r);
            control24TilknytningTilTrygdesystemetOgArbeidssituasjon(errorReport, r);
            control24BTilknytningTilTrygdesystemetOgArbeidssituasjonArbeidsavklaringspenger(errorReport, r);
            control25ArbeidssituasjonGyldigeKoder(errorReport, r);
            control26StonadsmaanederGyldigeKoder(errorReport, r);
            control27StonadssumManglerEllerHarUgyldigeTegn(errorReport, r);
            control28HarVarighetMenManglerStonadssum(errorReport, r);
            control29HarStonadssumMenManglerVarighet(errorReport, r);
            control30StonadssumPaaMaxEllerMer(errorReport, r);
            control31StonadssumPaaMinEllerMindre(errorReport, r);
            control32OkonomiskraadgivningGyldigeKoder(errorReport, r);
            control33UtarbeidelseAvIndividuellPlan(errorReport, r);
            control35Boligsituasjon(errorReport, r);
            control36BidragFordeltPaaMmaaneder(errorReport, r);
            control37LaanFordeltPaaMmaaneder(errorReport, r);
            control38DUFNummer(errorReport, r);
            control39ForsteVilkarIAaret(errorReport, r);
            control40ForsteVilkarIAaretSambo(errorReport, r);
            control41DatoForUtbetalingsvedtak(errorReport, r);
            control42TilOgMedDatoForUtbetalingsvedtak(errorReport, r);
            control43Vilkaar(errorReport, r);
        });
