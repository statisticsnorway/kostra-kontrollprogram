...
public class ControlFelt1LikSumAvListeTest {
    ...
    public void createFieldListTest1() {
        ...
        var matrix = ControlFelt1LikSumAvListe.createFieldList("heltall", List.of("S", "1", "2"), List.of("S", "1", "2"));
    ...
    public void createFieldListTest2() {
        ...
        var matrix = ControlFelt1LikSumAvListe.createFieldList(List.of("S", "1", "2"), List.of("S", "1", "2"));
