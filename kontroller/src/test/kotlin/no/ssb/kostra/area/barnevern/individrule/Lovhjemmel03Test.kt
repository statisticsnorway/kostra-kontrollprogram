...
import no.ssb.kostra.area.barnevern.RandomUtils.generateRandomSSN
                ...
                Then("expect null") {
                    ...
                    assertSoftly(reportEntryList.first()) {
                        ...
                        it.messageText shouldBe
                                "Tiltak (${currentContext.tiltak.first().id}). Individet er 19 år og skal dermed ikke ha omsorgstiltak"
                    }
                }
            }
        }
