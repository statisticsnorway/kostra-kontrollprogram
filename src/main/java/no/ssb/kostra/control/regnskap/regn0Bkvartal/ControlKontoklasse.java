...
// Skal kunne ha noen spesielle kontoklasse definisjoner (z og ~) som brukes i regnskap som ikke er avsluttet
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    if (foundError())
    {
      ...
      errorReport += "\tFeil: ukjent kontoklasse i " + numOfRecords + 
