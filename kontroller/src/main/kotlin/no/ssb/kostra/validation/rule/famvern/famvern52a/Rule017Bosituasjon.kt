...
class Rule017Bosituasjon :
        ...
        context
            ...
            .map {
                createValidationReportEntry(
                    messageText =
                        "Det er ikke fylt ut om primærklienten bor sammen med andre ved sakens opprettelse eller " +
    ...
    companion object {
        private val fieldDefinition =
            fieldDefinitions.byColumnName(PRIMK_SAMBO_A_COL_NAME)
    }
}
