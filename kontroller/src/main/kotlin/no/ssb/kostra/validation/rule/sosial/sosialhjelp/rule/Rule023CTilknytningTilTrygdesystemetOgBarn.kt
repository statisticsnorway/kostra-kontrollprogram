...
class Rule023CTilknytningTilTrygdesystemetOgBarn: AbstractNoArgsRule<List<KostraRecord>>(
    SosialhjelpRuleId.SOSIALHJELP_K023C_TRYGDESYSTEMET_BARN_BARNETRYGD.title,
    Severity.ERROR
) {
