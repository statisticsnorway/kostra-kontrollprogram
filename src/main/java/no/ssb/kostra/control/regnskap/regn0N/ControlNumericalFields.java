...
{
  private final String ERROR_TEXT = "K13: Ulovlig tegn i tallfeltene";
...
//	  String funksjon = RecordFields.getFunksjon(line);  --tatt vekk av raz 28.01.2013 pga warning "The value of the local variable FUNKSJON is not used"
//	  String art = RecordFields.getArt(line);  --tatt vekk av raz 28.01.2013 pga warning "The value of the local variable ART is not used"
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    "\tSjekk at posisjonene 3..40 ikke inneholder ugyldige tegn." + lf;
