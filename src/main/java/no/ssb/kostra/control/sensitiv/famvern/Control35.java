...
public final class Control35 extends no.ssb.kostra.control.Control
    implements no.ssb.kostra.control.SingleRecordErrorReport
{
  private final String ERROR_TEXT = "K35: Saken avsluttet, men ikke satt avslutningsdato";
  ...
  public boolean doControl(String line, int lineNumber, String region, String statistiskEnhet)
  {
    ...
    if (field_30.equalsIgnoreCase("1") || field_30.equalsIgnoreCase("2")) {
      ...
      String field_32 = RecordFields.getFieldValue(line, 32);
      int checkValue = 0;
      checkValue = DatoFnr.validDateDDMMYY(field_32);
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    if (foundError())
    {
      ...
      " er det krysset av for at saken er avsluttet i rapporteringsåret, " + lf +
