...
public class MainITest52B {
    ...
    public void beforeTest() {
        ...
        String inputFileContent = """
                ...
                667600017000030aaabbb                        010220202030030050120150100130222       \s
        ...
        args = new Arguments(new String[]{"-s", "52BF", "-y", "2020", "-r", "667600"}, byteArrayInputStream);
    }

    @Test
    public void testDoControl() {
        var errorReport = Main.doControls(args);
