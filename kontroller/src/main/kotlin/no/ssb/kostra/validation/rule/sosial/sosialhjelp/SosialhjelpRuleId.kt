...
enum class SosialhjelpRuleId(val title: String) {
    ...
    SOSIALHJELP_K022_TRYGDESITUASJON_GYLDIGE_KODER("Kontroll 22: Trygdesituasjon. Gyldige koder."),
    SOSIALHJELP_K023A_TRYGDESYSTEMET_ALDER("Kontroll 23A: Tilknytning til trygdesystemet og alder. Yngre enn 62 år med alderspensjon."),
    SOSIALHJELP_K023B_TRYGDESYSTEMET_BARN_OVERGANGSSTONAD("Kontroll 23B: Tilknytning til trygdesystemet og barn. Overgangsstønad."),
    SOSIALHJELP_K023C_TRYGDESYSTEMET_BARN_BARNETRYGD("Kontroll 23C: Tilknytning til trygdesystemet og barn. Barnetrygd."),
