...
class Rule009KontaktTidligere :
        ...
        context
            ...
            .map {
                createValidationReportEntry(
                    messageText =
                        "Det er ikke fylt ut om primærklienten har vært i kontakt med/klient ved familievernet " +
    ...
    companion object {
        private val fieldDefinition: FieldDefinition =
            fieldDefinitions.byColumnName(KONTAKT_TIDL_A_COL_NAME)
    }
}
