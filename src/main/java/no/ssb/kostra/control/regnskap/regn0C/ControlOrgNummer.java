...
final class ControlOrgNummer extends no.ssb.kostra.control.Control
{
  ...
  {
    String orgNum = no.ssb.kostra.control.regnskap.regn0C.RecordFields.getOrgNummer (line);
  ...
  public String getErrorReport (int totalLineNumber)
  {
    ...
    if (numOfRecords > 0)
    {
      ...
      errorReport += lf + "\tKorreksjon: Skjema 0C skal ikke ha organisasjonsnummer i felt 5. Legg inn blanke/mellomrom i felt 5." + lf + lf;
    }
    return errorReport;
  }
