            ...
            " "
                ...
                .plus(
                    mapOf(
                        ...
                        SosialhjelpColumnNames.KOMMUNE_NR_COL_NAME to
                            RuleTestData
                                .argumentsInTest.region
                                .municipalityIdFromRegion(),
                        ...
                        SosialhjelpColumnNames.AVSL_DATO_COL_NAME to
                            " ".repeat(
                                6,
                            ),
                        SosialhjelpColumnNames.VKLO_COL_NAME to
                            fieldDefinitions
                                .byColumnName(SosialhjelpColumnNames.VKLO_COL_NAME)
                                .codeList
                                .first()
                                .code,
                        SosialhjelpColumnNames.ARBSIT_COL_NAME to
                            fieldDefinitions
                                .byColumnName(SosialhjelpColumnNames.ARBSIT_COL_NAME)
                                .codeList
                                .last()
                                .code,
                        SosialhjelpColumnNames.BIDRAG_COL_NAME to "1000",
                        SosialhjelpColumnNames.GITT_OKONOMIRAD_COL_NAME to
                            fieldDefinitions
                                .byColumnName(
                                ...
                                .first()
                                .code,
                        SosialhjelpColumnNames.FAAT_INDIVIDUELL_PLAN_COL_NAME to
                            fieldDefinitions
                                .byColumnName(
                                ...
                                .first()
                                .code,
                        SosialhjelpColumnNames.BOSIT_COL_NAME to
                            fieldDefinitions
                                .byColumnName(SosialhjelpColumnNames.BOSIT_COL_NAME)
                                .codeList
                                .first()
                                .code,
                        SosialhjelpColumnNames.BIDRAG_1_COL_NAME to "1000",
                        SosialhjelpColumnNames.VILKARSOSLOV_COL_NAME to
                            fieldDefinitions
                                .byColumnName(
                                ...
                                .last()
                                .code,
                        SosialhjelpColumnNames.VILKARSAMEKT_COL_NAME to
                            fieldDefinitions
                                .byColumnName(
