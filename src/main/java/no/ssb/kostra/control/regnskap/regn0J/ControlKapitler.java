...
final class ControlKapitler extends no.ssb.kostra.control.Control {
	...
	private String[] validFunksjoner = {
			...
			"33", "34", "39", "40", "41", "42",
			"43", "45", "46", "47", "51", "53",
			"55", "56", "580", "581", "5900", "5950",
			"5960", "5970", "5990", "9100", "9110", "9200",
			"9999" };
	...
	public String getErrorReport(int totalLineNumber) {
		String errorReport = "Kontroll 7, Ugyldig bruk av kapitler:" + lf + lf;
		...
		errorReport += lf + "\tKorreksjon: Rett opp feil kapittel med gyldig kapittel. For oversikt over gyldige kapitler se gjeldende versjon av KOSTRA-kontoplanen."
				+ lf + lf;
		return errorReport;
	}
