...
class Rule026RelasjonBehandlingssamtalerDeltatt : AbstractNoArgsRule<List<KostraRecord>>(
    ...
    companion object {
        val mappingList = listOf(
            ...
            Mapping("Barn over 18år", DELT_BARNO18_A_COL_NAME, SAMT_BARNO18_A_COL_NAME),
            Mapping("Foreldre", DELT_FORELDRE_A_COL_NAME, SAMT_FORELDRE_A_COL_NAME),
            Mapping("Øvrige familie", DELT_OVRFAM_A_COL_NAME, SAMT_OVRFAM_A_COL_NAME),
