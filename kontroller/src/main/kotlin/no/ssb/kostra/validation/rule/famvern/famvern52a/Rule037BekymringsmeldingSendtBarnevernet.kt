...
class Rule037BekymringsmeldingSendtBarnevernet :
    ...
    override fun validate(context: List<KostraRecord>) =
        context
            .filterNot { fieldDefinition.codeExists(it[BEKYMR_MELD_A_COL_NAME]) }
            .map {
                createValidationReportEntry(
                    messageText =
                        "Det er ikke svart på hvorvidt bekymringsmelding er sendt barnevernet " +
    ...
    companion object {
        private val fieldDefinition =
            fieldDefinitions.byColumnName(BEKYMR_MELD_A_COL_NAME)
    }
}
