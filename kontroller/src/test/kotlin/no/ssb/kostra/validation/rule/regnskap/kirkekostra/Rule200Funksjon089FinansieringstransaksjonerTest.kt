...
class Rule200Funksjon089FinansieringstransaksjonerTest :
    BehaviorSpec({
        include(
            validationRuleNoArgsTest(
                sut = Rule200Funksjon089Finansieringstransaksjoner(listOf("500", "580", "830", "900", "980")),
                expectedSeverity = Severity.ERROR,
                ForAllRowItem(
                    "isBevilgningRegnskap = true, funksjon = 089, art != 500..580",
                    kostraRecordsInTest(skjema = "0F", funksjon = "089 ", art = "499"),
                    expectedErrorMessage =
                        "Art (499) er ugyldig mot funksjon 089. " +
                            "Gyldige arter er: ([500, 580, 830, 900, 980]).",
                ),
                ForAllRowItem(
