...
public class Main {
    public static ErrorReport doControls(Arguments args) {
        ...
        records.stream()
                ...
                .peek(r -> {
                    List<String> listCodes = r.getFieldDefinitionByName("VKLO").getCodeList().stream().map(Code::getCode).collect(Collectors.toList());
                    List<String> listTexts = r.getFieldDefinitionByName("VKLO").getCodeList().stream().map(Code::toString).collect(Collectors.toList());
                ...
                .peek(r -> {
                    // filtrerer ut 07 Alderspensjon fra mulige gyldige koder
                    List<String> listCodes = r.getFieldDefinitionByName("VKLO").getCodeList().stream().map(Code::getCode).filter(s -> !s.equalsIgnoreCase("07")).collect(Collectors.toList());
                    ...
                    if (!isAnyFilledIn) {
                        er.addEntry(
                                new ErrorReportEntry(
                                        ...
                                        , "Det er ikke krysset av for hvilke måneder mottakeren har fått utbetalt økonomisk sosialhjelp (bidrag eller lån)"
                    ...
                    if (!stonadOK) {
                        er.addEntry(
                                new ErrorReportEntry(
                                        ...
                                        , "Det er ikke oppgitt hvor mye mottakeren har fått i økonomisk sosialhjelp (bidrag eller lån) i løpet av året, "
                        ...
                        if (stonadOK && 0 < stonad) {
                            er.addEntry(
                                    new ErrorReportEntry(
                                            ...
                                            , "Det er ikke oppgitt hvor mye mottakeren har fått i økonomisk sosialhjelp (bidrag eller lån) i løpet av året, eller feltet inneholder andre tegn enn tall. Feltet er obligatorisk å fylle ut."
                                            , Constants.NORMAL_ERROR
                                    )
                            );
                        }
                        ...
                        if (!isAnyFilledIn) {
                            er.addEntry(
                                    new ErrorReportEntry(
                                            ...
                                            , "Mottakeren har fått i økonomisk sosialhjelp (bidrag eller lån) i løpet av året, "
                    ...
                    if (stonadOK && stonadSumMax < stonad) {
                        er.addEntry(
                                new ErrorReportEntry(
                                        ...
                                        , "Det samlede stønadsbeløpet (summen av bidrag og lån) som mottakeren har fått i løpet av rapporteringsåret overstiger Statistisk sentralbyrås kontrollgrense på kr. " + stonadSumMax + ",-."
                                        , Constants.NORMAL_ERROR
                                )
                        );
                    }
                    ...
                    if (stonadOK && stonad < stonadSumMin) {
                        er.addEntry(
                                new ErrorReportEntry(
                                        ...
                                        , "Det samlede stønadsbeløpet (summen av bidrag og lån) som mottakeren har fått i løpet av rapporteringsåret er lik/lavere enn Statistisk sentralbyrås kontrollgrense på kr. " + stonadSumMin + ",-."
                                        , Constants.NORMAL_ERROR
                                )
                        );
                    }
                    ...
                    if (0 < bidrag && bidrag != bidragSum) {
                        er.addEntry(
                                new ErrorReportEntry(
                                        ...
                                        , "Det er ikke fylt ut bidrag fordelt på måneder eller sum stemmer ikke med sum bidrag utbetalt i løpet av året."
                                        , Constants.CRITICAL_ERROR
                                )
                        );
                    }
                    ...
                    if (0 < laan && laan != laanSum) {
                        er.addEntry(
                                new ErrorReportEntry(
                                        ...
                                        , "Det er ikke fylt ut laan fordelt på måneder eller sum stemmer ikke med sum lån utbetalt i løpet av året."
                                        , Constants.CRITICAL_ERROR
                                )
                        );
                    }
